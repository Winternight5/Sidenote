        ...
        if (filterFunction === undefined) {
            ...
            for (var i = 0, il = is.length; i < il; i++) {
                ...
                if( Object.prototype.toString.call(filterFunction) === '[object Array]' ) {
                  ...
                  // While item passes filterFunctions, continue. 
                  // No need to continue checking filters if it fails an earlier filter function
                  while( n < filterFunction.length && pass ) { 
